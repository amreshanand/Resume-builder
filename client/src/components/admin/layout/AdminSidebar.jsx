...
const MENU_ITEMS = [
    ...
    { id: 'categories', label: 'Categories', icon: 'M7 4a1 1 0 00-1 1v2a1 1 0 001 1h1v2H7a1 1 0 00-1 1v2a1 1 0 001 1h1v2H7a1 1 0 00-1 1v2a1 1 0 001 1h10a1 1 0 001-1v-2a1 1 0 00-1-1h-1v-2h1a1 1 0 001-1v-2a1 1 0 00-1-1h-1V8h1a1 1 0 001-1V5a1 1 0 00-1-1H7zm3 4V6h4v2h-4zm0 6v-2h4v2h-4zm0 6v-2h4v2h-4z' },
                ...
                <div>
                    ...
                    <div className="space-y-1">
                        {MENU_ITEMS.slice(0, 1).map((item) => (
                            ...
                            >
                                <svg className={`w-5 h-5 ${activeTab === item.id ? 'text-amber-600' : 'text-slate-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="space-y-1">
                        {MENU_ITEMS.slice(1).map((item) => (
                            ...
                            >
                                ...
                                {item.id === 'resumes' && (
                                    <span className="bg-amber-100 text-amber-600 py-0.5 px-2.5 rounded-full text-[10px] font-bold">New</span>
                                )}
                            </button>
                        ))}
                    </div>
