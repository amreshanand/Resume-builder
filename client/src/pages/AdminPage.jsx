            ...
            <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
                ...
                <header className="h-20 bg-white border-b border-slate-200 flex items-center justify-between px-8 z-20 shrink-0">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="hidden lg:flex items-center bg-slate-50 rounded-full px-4 py-2 border border-slate-200 focus-within:ring-2 focus-within:ring-amber-500/20 focus-within:border-amber-500 transition-all">
